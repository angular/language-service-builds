...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var jp=function tt(t){this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")},Lp=new jp("6.0.8+9.sha-15df5f7"),Fp="ngDebugContext",Vp="ngOriginalError",Hp="ngErrorLogger";function Bp(t){return t[Fp]}function qp(t){return t[Vp]}function Kp(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];t.error.apply(t,c(e))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
