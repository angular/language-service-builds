...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function NC(e){return{start:e.getStart(),end:e.getEnd()}}function kC(e){return{message:e.message,next:e.next?kC(e.next):void 0}}var AC=new WeakMap,PC=new P_("8.0.0-rc.3+43.sha-381d7c4.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
