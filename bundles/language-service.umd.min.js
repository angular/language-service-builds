 ...
 * found in the LICENSE file at https://angular.io/license
 */
function stringifyValueForError(value){return value&&value.native&&value.native.outerHTML?value.native.outerHTML:"string"==typeof value?'"'+value+'"':value}function assertNotNull$1(actual,name){assertNotEqual(actual,null,name)}function assertNotEqual(actual,expected,name){actual==expected&&assertThrow(actual,expected,name,"!=")}function assertThrow(actual,expected,name,operator,serializer){void 0===serializer&&(serializer=stringifyValueForError);var error="ASSERT: expected "+name+" "+operator+" "+serializer(expected)+" but was "+serializer(actual)+"!";throw new Error(error)}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
