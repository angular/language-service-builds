...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e),-1===e[qp].id&&jh(e[th])&&e[th].destroy()}}var Kh,zh,Wh,Qh,Gh,Xh,$h,Yh,Zh=Promise.resolve(null),Jh="__CIRCULAR__";function tf(){return zh}var ef=!1,nf=!0,rf=-1;function of(t,e){var n=Yh;return Gh=t&&t[qp],$h=t&&1==(1&t[Kp]),nf=t&&Gh.firstTemplatePass,rf=t&&Gh.bindingStartIndex,Kh=t&&t[th],Wh=e,Qh=!0,Yh=t,n&&(n[Qp]=Xh),Xh=t&&t[Qp],n}function sf(t,e){e||(ef||Nh(Yh,Gh.viewHooks,Gh.viewCheckHooks,$h),Yh[Kp]&=-6),Yh[Kp]|=16,Yh[$p]=Gh.bindingStartIndex,of(t,null)}function af(){uf();var t=nf;Gh.firstTemplatePass=nf=!1,ef||Ah(Yh,Gh,$h),function e(t){for(var e=Hh(t);null!==e;e=e[Wp])if(e.length<Up&&-1===e[ch])for(var n=e,r=0;r<n[lh].length;r++){var i=n[lh][r];hf(i,i[qp],i[Zp],2)}}(Yh),function n(t){if(null!=t.contentQueries)for(var e=0;e<t.contentQueries.length;e+=2){var n=t.contentQueries[e];t.data[n].contentQueriesRefresh(n-Up,t.contentQueries[e+1])}}(Gh),ef||Nh(Yh,Gh.contentHooks,Gh.contentCheckHooks,$h),function r(t,e){if(null!=t)for(var n=0;n<t.length;n++)Ef(t[n],e)}(Gh.components,t)}function uf(){if(Gh.expandoInstructions){rf=Yh[$p]=Gh.expandoStartIndex;for(var t=-1,e=-1,n=0;n<Gh.expandoInstructions.length;n++){var r=Gh.expandoInstructions[n];"number"==typeof r?r<=0?(e=-r,"number"==typeof Yh[rf]&&(rf+=Dh),t=rf):rf+=r:(Yh[$p]=rf,r(t-Up,e),t++)}}}function cf(t,e,n,r,i){var o=e.blueprint.slice();return o[Kp]=25|r,o[zp]=o[rh]=Yh,o[Zp]=n,o[Jp]=Yh?Yh[Jp]:null,o[th]=t,o[eh]=i||null,o}function lf(t,e,n,r,i){var o=t+Up;Yh[o]=n;var s=Gh.data[o];return null==s&&(s=Gh.data[o]=wf(e,o,r,i,null),Wh&&(!Qh||null!=Wh.child||null===s.parent&&2!==Wh.type?Qh||(Wh.next=s):Wh.child=s)),null==Gh.firstChild&&3===e&&(Gh.firstChild=s),Wh=s,Qh=!0,s}function pf(t,e){return null==e[qp].node&&(e[qp].node=wf(2,t,null,null,null)),Qh=!0,Wh=e[Xp]=e[qp].node}function hf(t,e,n,r){var i,o=Qh,s=Wh;if(64&t[Kp])Cf(t[Zp]);else try{Qh=!0,Wh=null,i=of(t,t[Xp]),yf(),e.template(r,n),2&r?af():t[qp].firstTemplatePass=nf=!1}finally{sf(i,1==(1&r)),Qh=o,Wh=s}}function ff(t,e,n){var r=of(t,t[Xp]);try{zh.begin&&zh.begin(),n?(yf(),n(df(t),e),af()):(function i(){ef||(Ah(Yh,Gh,$h),Nh(Yh,Gh.contentHooks,Gh.contentCheckHooks,$h))}(),uf(),Ef(Up,!1))}finally{zh.end&&zh.end(),sf(r)}}function df(t){return 1&t[Kp]?3:2}var vf=null;function yf(){vf=null}function mf(t,e){var n=e||Kh;return jh(n)?n.createElement(t,vf):null===vf?n.createElement(t):n.createElementNS(vf,t)}function gf(t,e,n){if(null===n[e]){n[e]=Jh;var r=t.factory();return function i(t,e,n){var r=xf(t,e,n,hh(Wh,Yh));return n.template&&(fh(Wh.index,Yh)[Zp]=e),nf&&Sh(t,n.onInit,n.doCheck,Gh),Wh&&Wh.attrs&&function i(t,e,n,r){var i=r.initialInputs;(void 0===i||t>=i.length)&&(i=function o(t,e,n){var r=n.initialInputs||(n.initialInputs=[]);r[t]=null;for(var i=n.attrs,o=0;o<i.length;){var s=i[o];if(1===s)break;if(0!==s){var a=e[s],u=i[o+1];void 0!==a&&(r[t]||(r[t]=[])).push(a,u),o+=2}else o+=4}return r}(t,n,r));var s=i[t];if(s)for(var a=0;a<s.length;a+=2)e[s[a]]=s[a+1]}(t,r,n.inputs,Wh),n.contentQueries&&n.contentQueries(),r}(n[e]=Yh.length,r,t)}return n[e]===Jh&&function o(t){throw new Error("Cannot instantiate cyclic dependency! "+t)}(t.type),null}function _f(t,e,n,r,i,o,s){var a=Up+n,u=a+r,c=function l(t,e){var n=new Array(e).fill(null,0,t).fill(Nf,t);return n[nh]=-1,n[$p]=t,n}(a,u);return c[qp]={id:t,blueprint:c,template:e,viewQuery:s,node:null,data:c.slice(),childIndex:-1,bindingStartIndex:a,expandoStartIndex:u,expandoInstructions:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,contentQueries:null,components:null,directiveRegistry:"function"==typeof i?i():i,pipeRegistry:"function"==typeof o?o():o,currentMatches:null,firstChild:null}}function bf(t,e){zh=t;var n=t.createRenderer(null,null);return"string"==typeof e?jh(n)?n.selectRootElement(e):n.querySelector(e):e}function wf(t,e,n,r,i){var o=Qh?Wh:Wh&&Wh.parent,s=o&&Yh&&o!==Yh[Xp]?o:null;return{type:t,index:e,injectorIndex:s?s.injectorIndex:-1,flags:0,tagName:n,attrs:r,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:i,next:null,child:null,parent:s,detached:null,stylingTemplate:null,projection:null}}function xf(t,e,n,r){if(gh(e,Yh),r&&gh(r,Yh),Yh[t]=e,nf){var i=Wh.flags;0===i?Wh.flags=t<<15|4096&i|1:Wh.flags++,Gh.data.push(n),Gh.blueprint.push(null),n.hostBindings&&function o(t,e){Gh.expandoInstructions.push(e.hostBindings,e.hostVars)}(0,n)}else{var s=n.diPublic;s&&s(n)}return null!=n.attributes&&3==Wh.type&&function a(t,e){for(var n=jh(Kh),r=0;r<e.length;){var i=e[r];if(1===i)break;if(i===Rh)r+=2;else if(0===i){var o=e[r+1],s=e[r+2],a=e[r+3];n?Kh.setAttribute(t,s,a,o):t.setAttributeNS(o,s,a),r+=4}else a=e[r+1],n?Kh.setAttribute(t,i,a):t.setAttribute(i,a),r+=2}}(r,n.attributes),e}function Ef(t,e){var n=fh(t,Yh);Sf(n)&&6&n[Kp]&&(e&&function r(t){for(var e=t[qp],n=t.length;n<e.blueprint.length;n++)t[n]=e.blueprint[n]}(n),Af(n,n[Zp]))}function Sf(t){return 8==(8&t[Kp])}function Cf(t){for(var e=0;e<t.components.length;e++){var n=t.components[e];ff(yh(n),n)}}function Tf(t){Af(function e(t){var e,n=vh(t);if(Array.isArray(n)){var r=wh(n,t);(i=mh(n,r,(e=fh(r,n))[Gp])).component=t,gh(t,i),gh(i.native,i)}else{var i;e=fh((i=n).nodeIndex,i.lViewData)}return e}(t),t)}function Pf(t){Cf(t[Zp])}function Af(t,e){var n=t[qp],r=of(t,t[Xp]),i=n.template,o=n.viewQuery;try{yf(),function s(t,e,n){t&&1&e&&t(1,n)}(o,t[Kp],e),i(df(t),e),af(),function a(t,e){t&&t(2,e)}(o,e)}finally{sf(r)}}var Nf={},kf=Zh,Of=[0,1];function Mf(t,e,n,r,i,o){var s=xf(r.length,n.factory(),n,t);return i.components.push(s),e[Zp]=s,o&&o.forEach(function(t){return t(s,n)}),r[qp].firstTemplatePass&&function a(t){for(var e=0;e<t;e++)Yh.push(Nf),Gh.blueprint.push(Nf),Gh.data.push(null)}(n.hostVars),uf(),s}function If(t,e){return{components:[],scheduler:t,clean:kf,playerHandler:e||null,flags:0}}function Df(t,e){var n=yh(t)[qp],r=n.data.length-1;Sh(r,e.onInit,e.doCheck,n),function i(t,e){if(e.firstTemplatePass)for(var n=t>>15,r=n+(4095&t),i=n;i<r;i++){var o=e.data[i];Ch(o,e,i),Th(o,e,i),Ph(o,e,i)}}(r<<15|1,n)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
