...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function uT(e){return{start:e.getStart(),end:e.getEnd()}}function lT(e){return{message:e.message,next:e.next?lT(e.next):void 0}}var cT=new WeakMap,pT=new ub("8.1.0-beta.0+8.sha-6d861f2.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
