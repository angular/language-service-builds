...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function kC(e){return{start:e.getStart(),end:e.getEnd()}}function AC(e){return{message:e.message,next:e.next?AC(e.next):void 0}}var PC=new WeakMap,IC=new I_("8.0.0-rc.0+68.sha-e53cf81.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
