...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function hT(e){return{start:e.getStart(),end:e.getEnd()}}function fT(e){return{message:e.message,next:e.next?fT(e.next):void 0}}var dT=new WeakMap,vT=new pb("8.1.0-beta.0+25.sha-07cd65b.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
