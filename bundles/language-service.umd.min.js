...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function CC(e){return{start:e.getStart(),end:e.getEnd()}}function TC(e){return{message:e.message,next:e.next?TC(e.next):void 0}}var NC=new WeakMap,kC=new k_("8.0.0+42.sha-be82270.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
