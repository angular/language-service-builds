...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Md(e){return{token:e.token,providedIn:e.providedIn||null,factory:e.factory,value:void 0}}function Od(e){var t=e[Rd];return t&&t.token===e?t:null}function Dd(e){return e&&e.hasOwnProperty(Ld)?e[Ld]:null}Sd("Host"),Sd("Attribute",function(e){return{attributeName:e}}),function(e){e[e.Default=0]="Default",e[e.Host=1]="Host",e[e.Self=2]="Self",e[e.SkipSelf=4]="SkipSelf",e[e.Optional=8]="Optional"}(Td||(Td={}));var Rd=Id({ngInjectableDef:Id}),Ld=Id({ngInjectorDef:Id});
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Qd,Gd=function(){function e(e,t){this._desc=e,this.ngMetadataName="InjectionToken",this.ngInjectableDef=void 0,"number"==typeof t?this.__NG_ELEMENT_ID__=t:void 0!==t&&(this.ngInjectableDef=Md({token:this,providedIn:t.providedIn||"root",factory:t.factory}))}return e.prototype.toString=function(){return"InjectionToken "+this._desc},e}(),$d=new Gd("INJECTOR",-1),Xd=new Object,Yd="ngTempTokenPath",Zd="ngTokenPath",Jd=/\n/gm,ev="ɵ",tv="__source",nv=Id({provide:String,useValue:Id}),rv=void 0;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function fT(e){return{start:e.getStart(),end:e.getEnd()}}function dT(e){return{message:e.message,next:e.next?dT(e.next):void 0}}var vT=new WeakMap,mT=new hb("8.1.0-next.1+47.sha-7912db3.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
