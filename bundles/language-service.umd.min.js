...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function dT(e){return{start:e.getStart(),end:e.getEnd()}}function vT(e){return{message:e.message,next:e.next?vT(e.next):void 0}}var mT=new WeakMap,yT=new fb("8.1.0-rc.0+14.sha-4f38419.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
