 ...
 * found in the LICENSE file at https://angular.io/license
 */
Object.defineProperty(exports,"__esModule",{value:!0}),exports.DEFAULT_ERROR_CODE=100,exports.UNKNOWN_ERROR_CODE=500,exports.SOURCE="angular";var EmitFlags;!function(EmitFlags){EmitFlags[EmitFlags.DTS=1]="DTS",EmitFlags[EmitFlags.JS=2]="JS",EmitFlags[EmitFlags.Metadata=4]="Metadata",EmitFlags[EmitFlags.I18nBundle=8]="I18nBundle",EmitFlags[EmitFlags.Summary=16]="Summary",EmitFlags[EmitFlags.Default=3]="Default",EmitFlags[EmitFlags.All=31]="All"}(EmitFlags=exports.EmitFlags||(exports.EmitFlags={}))}),check_types=createCommonjsModule(function(module,exports){function diagnosticMessageToString(message){return ts__default.flattenDiagnosticMessageText(message,"\n")}function createFactoryInfo(emitter,file){var _a=emitter.emitStatementsAndContext(file.srcFileUrl,file.genFileUrl,file.stmts,void 0,void 0,function(reference){return!(!reference.name||!REWRITE_PREFIX.test(reference.name))}),sourceText=_a.sourceText,context=_a.context,source=ts__default.createSourceFile(file.genFileUrl,sourceText,ts__default.ScriptTarget.Latest,!0);return{source:source,context:context}}/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var projectHostMap=new WeakMap,angularOnlyResults=process.argv.indexOf("--angularOnlyResults")>=0,VERSION=new Version$1("5.0.0-beta.6-5ef6e63");exports.createLanguageService=createLanguageService,exports.TypeScriptServiceHost=TypeScriptServiceHost,exports.createLanguageServiceFromTypescript=createLanguageServiceFromTypescript,exports.VERSION=VERSION,exports.getExternalFiles=getExternalFiles,exports.create=create,Object.defineProperty(exports,"__esModule",{value:!0})});
//# sourceMappingURL=/home/travis/build/angular/angular/dist/packages-dist/language-service/bundles/language-service.umd.min.js.map