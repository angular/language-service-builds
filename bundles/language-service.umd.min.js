...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function JC(e){return{start:e.getStart(),end:e.getEnd()}}function eT(e){return{message:e.message,next:e.next?eT(e.next):void 0}}var tT=new WeakMap,nT=new tb("8.0.0-rc.0+353.sha-8a68ec0.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
