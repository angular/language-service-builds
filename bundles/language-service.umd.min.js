...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Vp=function mt(t){this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")},Hp=new Vp("6.1.0+55.sha-e3834b7"),Bp="ngDebugContext",qp="ngOriginalError",Kp="ngErrorLogger";function Up(t){return t[Bp]}function zp(t){return t[qp]}function Wp(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];t.error.apply(t,l(e))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Zp=function(){function t(t,e){if(this.token=t,this.id=e,!t)throw new Error("Token must be defined!");this.displayName=Xl(this.token)}return t.get=function(t){return Jp.get(rp(t))},Object.defineProperty(t,"numberOfKeys",{get:function(){return Jp.numberOfKeys},enumerable:!0,configurable:!0}),t}(),Jp=new(function(){function t(){this._allKeys=new Map}return t.prototype.get=function(t){if(t instanceof Zp)return t;if(this._allKeys.has(t))return this._allKeys.get(t);var e=new Zp(t,Zp.numberOfKeys);return this._allKeys.set(t,e),e},Object.defineProperty(t.prototype,"numberOfKeys",{get:function(){return this._allKeys.size},enumerable:!0,configurable:!0}),t}()),th=new(function(){function t(t){this.reflectionCapabilities=t}return t.prototype.updateCapabilities=function(t){this.reflectionCapabilities=t},t.prototype.factory=function(t){return this.reflectionCapabilities.factory(t)},t.prototype.parameters=function(t){return this.reflectionCapabilities.parameters(t)},t.prototype.annotations=function(t){return this.reflectionCapabilities.annotations(t)},t.prototype.propMetadata=function(t){return this.reflectionCapabilities.propMetadata(t)},t.prototype.hasLifecycleHook=function(t,e){return this.reflectionCapabilities.hasLifecycleHook(t,e)},t.prototype.getter=function(t){return this.reflectionCapabilities.getter(t)},t.prototype.setter=function(t){return this.reflectionCapabilities.setter(t)},t.prototype.method=function(t){return this.reflectionCapabilities.method(t)},t.prototype.importUri=function(t){return this.reflectionCapabilities.importUri(t)},t.prototype.resourceUri=function(t){return this.reflectionCapabilities.resourceUri(t)},t.prototype.resolveIdentifier=function(t,e,n,r){return this.reflectionCapabilities.resolveIdentifier(t,e,n,r)},t.prototype.resolveEnum=function(t,e){return this.reflectionCapabilities.resolveEnum(t,e)},t}())(new Jl),eh=function(){function t(t,e,n){this.key=t,this.optional=e,this.visibility=n}return t.fromKey=function(e){return new t(e,!1,null)},t}(),nh=[],rh=function rh(t,e,n){this.key=t,this.resolvedFactories=e,this.multiProvider=n,this.resolvedFactory=this.resolvedFactories[0]},ih=function ih(t,e){this.factory=t,this.dependencies=e};function oh(t){return new rh(Zp.get(t.provide),[function e(t){var e,n;if(t.useClass){var r=rp(t.useClass);e=th.factory(r),n=sh(r)}else t.useExisting?(e=function(t){return t},n=[eh.fromKey(Zp.get(t.useExisting))]):t.useFactory?(e=t.useFactory,n=function i(t,e){if(e){var n=e.map(function(t){return[t]});return e.map(function(e){return ah(t,e,n)})}return sh(t)}(t.useFactory,t.deps)):(e=function(){return t.useValue},n=nh);return new ih(e,n)}(t)],t.multi||!1)}function sh(t){var e=th.parameters(t);if(!e)return[];if(e.some(function(t){return null==t}))throw Yp(t,e);return e.map(function(n){return ah(t,n,e)})}function ah(t,e,n){var r=null,i=!1;if(!Array.isArray(e))return uh(e instanceof ip?e.token:e,i,null);for(var o=null,s=0;s<e.length;++s){var a=e[s];a instanceof Vl?r=a:a instanceof ip?r=a.token:a instanceof op?i=!0:a instanceof sp||a instanceof ap?o=a:a instanceof Ol&&(r=a)}if(null!=(r=rp(r)))return uh(r,i,o);throw Yp(t,n)}function uh(t,e,n){return new eh(Zp.get(t),e,n)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(this,function(t){return' "'+t.key.displayName+'" '}).join(", ")+"])"},enumerable:!0,configurable:!0}),t.prototype.toString=function(){return this.displayName},t.INJECTOR_KEY=Zp.get(fp),t}(),hh=new Ol("The presence of this token marks an injector as being the root injector."),fh={},dh={},vh=[],yh=void 0;function mh(){return void 0===yh&&(yh=new hp),yh}var gh=function(){function t(t,e,n){var r=this;this.parent=n,this.records=new Map,this.injectorDefTypes=new Set,this.onDestroy=new Set,this.destroyed=!1,wh([t],function(t){return r.processInjectorType(t,new Set)}),e&&wh(e,function(t){return r.processProvider(t)}),this.records.set(pp,bh(void 0,this)),this.isRootInjector=this.records.has(hh),this.injectorDefTypes.forEach(function(t){return r.get(t)})}return t.prototype.destroy=function(){this.assertNotDestroyed(),this.destroyed=!0;try{this.onDestroy.forEach(function(t){return t.ngOnDestroy()})}finally{this.records.clear(),this.onDestroy.clear(),this.injectorDefTypes.clear()}},t.prototype.get=function(t,e,n){void 0===e&&(e=lp),void 0===n&&(n=0),this.assertNotDestroyed();var r=Ap(this);try{if(!(4&n)){var i=this.records.get(t);if(void 0===i){var o=function s(t){return"function"==typeof t||"object"==typeof t&&t instanceof Ol}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */!function(t){function e(e,n,r){var i=t.call(this,e)||this;i.observables=n,i.project=r,i.toRespond=[];var o=n.length;i.values=new Array(o);for(var s=0;s<o;s++)i.toRespond.push(s);for(s=0;s<o;s++){var a=n[s];i.add(md(i,a,a,s))}return i}Xv(e,t),e.prototype.notifyNext=function(t,e,n,r,i){this.values[n]=e;var o=this.toRespond;if(o.length>0){var s=o.indexOf(n);-1!==s&&o.splice(s,1)}},e.prototype.notifyComplete=function(){},e.prototype._next=function(t){if(0===this.toRespond.length){var e=function(){for(var t=[],e=0;e<arguments.length;e++)t=t.concat($v(arguments[e]));return t}([t],this.values);this.project?this._tryProject(e):this.destination.next(e)}},e.prototype._tryProject=function(t){var e;try{e=this.project.apply(this,t)}catch(t){return void this.destination.error(t)}this.destination.next(e)}}(sd);var Zv=new Ol("Application Initializer"),Jv=function(){function t(t){var e=this;this.appInits=t,this.initialized=!1,this.done=!1,this.donePromise=new Promise(function(t,n){e.resolve=t,e.reject=n})}return t.prototype.runInitializers=function(){var t=this;if(!this.initialized){var e=[],n=function(){t.done=!0,t.resolve()};if(this.appInits)for(var r=0;r<this.appInits.length;r++){var i=this.appInits[r]();Yv(i)&&e.push(i)}Promise.all(e).then(function(){n()}).catch(function(e){t.reject(e)}),0===e.length&&n(),this.initialized=!0}},t.decorators=[{type:Fp}],t.ctorParameters=function(){return[{type:Array,decorators:[{type:ip,args:[Zv]},{type:op}]}]},t}();new Ol("AppId"),new Ol("Platform Initializer");var ty=new Ol("Platform ID"),ey=new Ol("appBootstrapListener"),ny=(new Ol("Application Packages Root URL"),function(){function t(){}return t.prototype.log=function(t){console.log(t)},t.prototype.warn=function(t){console.warn(t)},t.decorators=[{type:Fp}],t}());
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function $y(t,e,n){t.childNodes.forEach(function(t){t instanceof Xy&&(e(t)&&n.push(t),$y(t,e,n))})}function Yy(t,e,n){t instanceof Xy&&t.childNodes.forEach(function(t){e(t)&&n.push(t),t instanceof Xy&&Yy(t,e,n)})}var Zy=new Map;function Jy(t){return Zy.get(t)||null}function tm(t){Zy.set(t.nativeNode,t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Pg=new Object;!function(t){function e(e,n,r,i,o,s){var a=t.call(this)||this;return a.selector=e,a.componentType=n,a._inputs=i,a._outputs=o,a.ngContentSelectors=s,a.viewDefFactory=r,a}o(e,t),Object.defineProperty(e.prototype,"inputs",{get:function(){var t=[],e=this._inputs;for(var n in e)t.push({propName:n,templateName:e[n]});return t},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"outputs",{get:function(){var t=[];for(var e in this._outputs)t.push({propName:e,templateName:this._outputs[e]});return t},enumerable:!0,configurable:!0}),e.prototype.create=function(t,e,n,r){if(!r)throw new Error("ngModule should be provided");var i=ig(this.viewDefFactory),o=i.nodes[0].element.componentProvider.nodeIndex,s=Lm.createRootView(t,e||[],n,i,r,Pg),a=Rm(s,o).instance;return n&&s.renderer.setAttribute(Im(s,0).renderElement,"ng-version",Hp.full),new Ng(s,new Mg(s),a)}}(uy);var Ng=function(t){function e(e,n,r){var i=t.call(this)||this;return i._view=e,i._viewRef=n,i._component=r,i._elDef=i._view.def.nodes[0],i.hostView=n,i.changeDetectorRef=n,i.instance=r,i}return o(e,t),Object.defineProperty(e.prototype,"location",{get:function(){return new Ky(Im(this._view,this._elDef.nodeIndex).renderElement)},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"injector",{get:function(){return new jg(this._view,this._elDef)},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"componentType",{get:function(){return this._component.constructor},enumerable:!0,configurable:!0}),e.prototype.destroy=function(){this._viewRef.destroy()},e.prototype.onDestroy=function(t){this._viewRef.onDestroy(t)},e}(ay);function Ag(t,e,n){return new kg(t,e,n)}var kg=function(){function t(t,e,n){this._view=t,this._elDef=e,this._data=n,this._embeddedViews=[]}return Object.defineProperty(t.prototype,"element",{get:function(){return new Ky(this._data.renderElement)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"injector",{get:function(){return new jg(this._view,this._elDef)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"parentInjector",{get:function(){for(var t=this._view,e=this._elDef.parent;!e&&t;)e=Ym(t),t=t.parent;return t?new jg(t,e):new jg(this._view,null)},enumerable:!0,configurable:!0}),t.prototype.clear=function(){for(var t=this._embeddedViews.length-1;t>=0;t--){var e=xg(this._data,t);Lm.destroyView(e)}},t.prototype.get=function(t){var e=this._embeddedViews[t];if(e){var n=new Mg(e);return n.attachToViewContainerRef(this),n}return null},Object.defineProperty(t.prototype,"length",{get:function(){return this._embeddedViews.length},enumerable:!0,configurable:!0}),t.prototype.createEmbeddedView=function(t,e,n){var r=t.createEmbeddedView(e||{});return this.insert(r,n),r},t.prototype.createComponent=function(t,e,n,r,i){var o=n||this.parentInjector;i||t instanceof py||(i=o.get(hy));var s=t.create(o,r,void 0,i);return this.insert(s.hostView,e),s},t.prototype.insert=function(t,e){if(t.destroyed)throw new Error("Cannot insert a destroyed View in a ViewContainer!");var n=t;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var _b=17,bb=0,wb=1,xb=2,Eb=3,Sb=4,Cb=5,Tb=6,Pb=7,Nb=8,Ab=9,kb=10,Ob=11,Mb=12,Ib=13,Rb=14;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function Db(t,e,n,r){e&&(r.initHooks||(r.initHooks=[])).push(t,e),n&&((r.initHooks||(r.initHooks=[])).push(t,n),(r.checkHooks||(r.checkHooks=[])).push(t,n))}function jb(t,e,n){t.afterContentInit&&(e.contentHooks||(e.contentHooks=[])).push(n,t.afterContentInit),t.afterContentChecked&&((e.contentHooks||(e.contentHooks=[])).push(n,t.afterContentChecked),(e.contentCheckHooks||(e.contentCheckHooks=[])).push(n,t.afterContentChecked))}function Lb(t,e,n){t.afterViewInit&&(e.viewHooks||(e.viewHooks=[])).push(n,t.afterViewInit),t.afterViewChecked&&((e.viewHooks||(e.viewHooks=[])).push(n,t.afterViewChecked),(e.viewCheckHooks||(e.viewCheckHooks=[])).push(n,t.afterViewChecked))}function Fb(t,e,n){null!=t.onDestroy&&(e.destroyHooks||(e.destroyHooks=[])).push(n,t.onDestroy)}function Vb(t,e,n){16&t[Sb]&&(Hb(t[Pb],e.initHooks,e.checkHooks,n),t[Sb]&=-17)}function Hb(t,e,n,r){var i=r?e:n;i&&Bb(t,i)}function Bb(t,e){for(var n=0;n<e.length;n+=2)e[n+1].call(t[e[n]])}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var qb,Kb=0,Ub=4,zb=5,Wb="ngProjectAs";function Qb(t){return!!t.listen}!function(t){t[t.Important=1]="Important",t[t.DashCase=2]="DashCase"}(qb||(qb={}));var Gb={createRenderer:function(t,e){return document}};
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Xb(t){return Array.isArray(t)?t[0]:t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function $b(t){if(2===t.tNode.type){var e=t.data;return e[xb]?e[xb][Cb]:null}return t.tNode.next?t.view[t.tNode.next.index]:null}function Yb(t){return t.tNode.child?Xb((2===t.tNode.type?t.data:t.view)[t.tNode.child.index]):null}function Zb(t){if(-1===t.tNode.index&&2===t.tNode.type){var e=t.data[Rb];return-1===e?null:t.view[e].dynamicLContainerNode}var n=t.tNode.parent;return Xb(n?t.view[n.index]:t.view[Cb])}var Jb=[];function tw(t,e,n,r,i,o){for(var s=t,a=-1;s;){var u=null,c=i?i.native:null,l=s.tNode.type;if(3===l)nw(n,r,c,s.native,o),s.dynamicLContainerNode&&nw(n,r,c,s.dynamicLContainerNode.native,o);else if(0===l){nw(n,r,c,s.native,o);var p=s,h=p.dynamicLContainerNode?p.dynamicLContainerNode.data:p.data;i&&(h[zb]=i),(u=h[Ub].length?Yb(h[Ub][0]):null)&&(o=p.dynamicLContainerNode?p.dynamicLContainerNode.native:p.native)}else if(1===l){var f=ew(s.view),d=f.tNode.projection[s.tNode.projection];Jb[++a]=s,u=d?f.data[wb][d.index]:null}else u=Yb(s);if(null===u)for(null===(u=$b(s))&&8192&s.tNode.flags&&(u=$b(Jb[a--]));s&&!u;){if(null===(s=Zb(s))||s===e)return null;s.tNode.next||0!==l||(o=s.native),u=$b(s)}s=u}}function ew(t){for(var e=t[Cb];2===e.tNode.type;)e=(t=t[wb])[Cb];return e}function nw(t,e,n,r,i){0===t?Qb(e)?e.insertBefore(n,r,i):n.insertBefore(r,i,!0):1===t?Qb(e)?e.removeChild(n,r):n.removeChild(r):2===t&&e.destroyNode(r)}function rw(t,e,n,r){var i=t.data[zb];i&&i.native&&tw(Yb(e),e,n?0:1,t.view[Ob],i,r)}function iw(t,e,n){var r=t.data[Ub],i=e.data;return n>0&&(r[n-1].data[xb]=i),n<r.length?(i[xb]=r[n].data,r.splice(n,0,e)):(r.push(e),i[xb]=null),-1===e.tNode.index&&(i[Rb]=t.tNode.parent.index,e.view=t.view),i[Eb]&&i[Eb].insertView(n),i[Sb]|=8,e}function ow(t,e){var n=t.data[Ub],r=n[e];e>0&&(n[e-1].data[xb]=r.data[xb]),n.splice(e,1),t.tNode.detached||rw(t,r,!1);var i=r.data;return i[Eb]&&i[Eb].removeView(),i[Rb]=-1,r.view=null,r.data[Sb]&=-9,r}function sw(t){if(-1===t[bb].childIndex)return null;var e=t[t[bb].childIndex];return e.data?e.data:e.dynamicLContainerNode.data}function aw(t){var e=t[Ob];Qb(e)&&e.destroyNode&&tw(t[Cb],t[Cb],2,e),function n(t){if(-1===t[bb].childIndex)return cw(t);for(var e=sw(t);e;){var n=null;if(e.length>=_b?e[bb].childIndex>-1&&(n=sw(e)):e[Ub].length&&(n=e[Ub][0].data),null==n){for(;e&&!e[xb]&&e!==t;)cw(e),e=uw(e,t);cw(e||t),n=e&&e[xb]}e=n}}(t),t[Sb]|=32}function uw(t,e){var n;return(n=t[Cb])&&2===n.tNode.type?Zb(n).data:t[wb]===e?null:t[wb]}function cw(t){if(t[bb]){var e=t;!function n(t){var e=t[bb].cleanup;if(null!=e){for(var n=0;n<e.length-1;n+=2)"string"==typeof e[n]?(Xb(t[e[n+1]]).native.removeEventListener(e[n],t[Nb][e[n+2]],e[n+3]),n+=2):"number"==typeof e[n]?(0,t[Nb][e[n]])():e[n].call(t[Nb][e[n+1]]);t[Nb]=null}}(e),function r(t){var e,n=t[bb];null!=n&&null!=(e=n.destroyHooks)&&Bb(t[Pb],e)}(e),function i(t){var e=t[bb]&&t[bb].pipeDestroyHooks;e&&Bb(t,e)}(e),-1===e[bb].id&&Qb(e[Ob])&&e[Ob].destroy()}}function lw(t,e){if(3===t.tNode.type)return t.view!==e||null===t.data;var n=Zb(t);return null!=n&&null!=n.data[zb]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var pw,hw,fw,dw,vw,yw,mw,gw,_w,bw="__ngHostLNode__",ww=Promise.resolve(null),xw=[0,0],Ew=new Array(_b).fill(null),Sw="__CIRCULAR__";function Cw(){return gw&&gw[Mb]}var Tw=!1,Pw=!0;function Nw(t,e){var n=gw;return _w=t&&t[Pb],vw=t&&t[bb],mw=t&&1==(1&t[Sb]),Pw=t&&vw.firstTemplatePass,pw=t&&t[Ob],null!=e&&(fw=e,dw=!0),gw=t,yw=t&&t[Eb],n}function Aw(t,e){e||(Tw||Hb(_w,vw.viewHooks,vw.viewCheckHooks,mw),gw[Sb]&=-6),gw[Sb]|=16,gw[Tb]=-1,Nw(t,null)}function kw(){vw.firstTemplatePass=Pw=!1,Tw||Vb(gw,vw,mw),function t(e){for(var n=sw(e);null!==n;n=n[xb])if(n.length<_b&&null===n[Kb])for(var r=n,i=0;i<r[Ub].length;i++){var o=r[Ub][i],s=o.data;Dw(o,s[bb],s[Ab],2)}}(gw),Tw||Hb(_w,vw.contentHooks,vw.contentCheckHooks,mw),Ow(vw.hostBindings),function e(t){if(null!=t.contentQueries)for(var e=0;e<t.contentQueries.length;e+=2){var n=t.contentQueries[e];t.directives[n].contentQueriesRefresh(n,t.contentQueries[e+1])}}(vw),function n(t){if(null!=t)for(var e=0;e<t.length;e++)Xw(t[e])}(vw.components)}function Ow(t){if(null!=t)for(var e=vw.directives,n=0;n<t.length;n+=2){var r=t[n],i=e[r];i.hostBindings&&i.hostBindings(r,t[n+1])}}function Mw(t,e,n,r,i){return[e,gw,null,null,25|r,null,-1,null,null,n,gw?gw[kb]:null,t,i||null,null,-1,null,null]}function Iw(t,e,n,r,i,o){return{native:r,view:e,nodeInjector:n?n.nodeInjector:null,data:i,queries:o,tNode:null,dynamicLContainerNode:null}}function Rw(t,e,n,r,i,o){var s=dw?fw:fw&&Zb(fw),a=s&&s.view===gw?s.tNode:null,u=(dw?yw:fw&&fw.queries)||s&&s.queries&&s.queries.child(),c=null!=o,l=Iw(0,gw,s,n,c?o:null,u);if(-1===t||2===e)l.tNode=(o?o[bb].node:null)||Ww(e,t,null,null,a,null);else{var p=t+_b,h=vw.data;if(gw[p]=l,p>=h.length){var f=h[p]=Ww(e,p,r,i,a,null);if(!dw&&fw){var d=fw.tNode;d.next=f,d.dynamicContainerNode&&(d.dynamicContainerNode.next=f)}}l.tNode=h[p],dw&&(yw=null,(null==fw.tNode.child&&fw.view===gw||2===fw.tNode.type)&&(fw.tNode.child=l.tNode))}if(2==(2&e)&&c){var v=o;v[Cb]=l,Pw&&(v[bb].node=l.tNode)}return fw=l,dw=!0,l}function Dw(t,e,n,r){var i,o=dw,s=fw;if(null==t.data[wb]&&t.data[Ab]&&!e.template)Zw(t.data[Ab]);else try{dw=!0,fw=null,i=Nw(t.data,t),Vw(),e.template(r,n),2&r?kw():t.data[bb].firstTemplatePass=Pw=!1}finally{Aw(i,1==(1&r)),dw=o,fw=s}return t}function jw(t,e,n,r){var i=Nw(e,t);try{hw.begin&&hw.begin(),r?(Vw(),r(Lw(e),n),kw()):(function o(){Tw||(Vb(gw,vw,mw),Hb(_w,vw.contentHooks,vw.contentCheckHooks,mw))}(),Ow(xw),Xw(_b))}finally{hw.end&&hw.end(),Aw(i)}}function Lw(t){return 1&t[Sb]?3:2}var Fw=null;function Vw(){Fw=null}function Hw(t,e,n,r){if(null===n[e]){n[e]=Sw;var i=t.factory();return(r.directives||(r.directives=[])).push(t),Qw(n[e]=r.directives.length-1,i,t)}return n[e]===Sw&&function o(t){throw new Error("Cannot instantiate cyclic dependency! "+t)}(t.type),null}function Bw(){Pw&&(vw.components||(vw.components=[])).push(gw.length-1)}function qw(t,e,n){t&&null!=t.changeDetectorRef&&t.changeDetectorRef._setComponentContext(n,e)}function Kw(t,e,n,r){return t.ngPrivateData||(t.ngPrivateData=Uw(-1,t,e,n,r))}function Uw(t,e,n,r,i){return{id:t,template:e,viewQuery:i,node:null,data:Ew.slice(),childIndex:-1,bindingStartIndex:-1,directives:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,hostBindings:null,contentQueries:null,components:null,directiveRegistry:"function"==typeof n?n():n,pipeRegistry:"function"==typeof r?r():r,currentMatches:null}}function zw(t,e){hw=t;var n=t.createRenderer(null,null);return"string"==typeof e?Qb(n)?n.selectRootElement(e):n.querySelector(e):e}function Ww(t,e,n,r,i,o){return{type:t,index:e,flags:0,tagName:n,attrs:r,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:o,next:null,child:null,parent:i,dynamicContainerNode:null,detached:null,stylingTemplate:null,projection:null}}function Qw(t,e,n){var r=Gw(t,e,n),i=fw.tNode;return n.template&&function o(t,e,n){var r=Kw(n.template,n.directiveDefs,n.pipeDefs,n.viewQuery),i=Yw(gw,fw.tNode.index,Mw(hw.createRenderer(fw.native,n.rendererType),r,e,n.onPush?4:2,Cw()));fw.data=i,i[Cb]=fw,qw(fw.nodeInjector,e,i),Pw&&Bw()}(0,e,n),Pw&&(Db(t,n.onInit,n.doCheck,vw),n.hostBindings&&function s(t){(vw.hostBindings||(vw.hostBindings=[])).push(t,gw.length-1-_b)}(t)),i&&i.attrs&&function a(t,e,n,r){var i=r.initialInputs;(void 0===i||t>=i.length)&&(i=function o(t,e,n){var r=n.initialInputs||(n.initialInputs=[]);r[t]=null;for(var i=n.attrs,o=0;o<i.length;){var s=i[o];if(1===s)break;if(0!==s){var a=e[s],u=i[o+1];void 0!==a&&(r[t]||(r[t]=[])).push(a,u),o+=2}else o+=4}return r}(t,n,r));var s=i[t];if(s)for(var a=0;a<s.length;a+=2)e[s[a]]=s[a+1]}(t,r,n.inputs,i),n.contentQueries&&n.contentQueries(),r}function Gw(t,e,n){if(Object.defineProperty(e,bw,{enumerable:!1,value:fw}),null==_w&&(gw[Pb]=_w=[]),_w[t]=e,Pw){var r=fw.tNode.flags;0==(4095&r)?fw.tNode.flags=t<<14|4096&r|1:fw.tNode.flags++}else{var i=n.diPublic;i&&i(n)}return null!=n.attributes&&3==fw.tNode.type&&function o(t,e){for(var n=Qb(pw),r=0;r<e.length;){var i=e[r];if(1===i)break;if(i===Wb)r+=2;else if(0===i){var o=e[r+1],s=e[r+2],a=e[r+3];n?pw.setAttribute(t,s,a,o):t.setAttributeNS(o,s,a),r+=4}else a=e[r+1],n?pw.setAttribute(t,i,a):t.setAttribute(i,a),r+=2}}(fw.native,n.attributes),e}function Xw(t){var e=gw[t],n=e.data;$w(n)&&6&n[Sb]&&nx(n,e,n[Ab])}function $w(t){return 8==(8&t[Sb])}function Yw(t,e,n){return t[Ib]?t[Ib][xb]=n:Pw&&(vw.childIndex=e),t[Ib]=n,n}function Zw(t){for(var e=0;e<t.components.length;e++){var n=t.components[e];jw(rx(n),Jw(n),n)}}function Jw(t){for(var e=rx(t).view;e[wb];)e=e[wb];return e}function tx(t){var e=rx(t);nx(e.data,e,t)}function ex(t){Zw(t[Ab])}function nx(t,e,n){var r=Nw(t,e),i=t[bb],o=i.template,s=i.viewQuery;try{Vw(),function a(t,e,n){t&&1&e&&t(1,n)}(s,t[Sb],n),o(Lw(t),n),kw(),function u(t,e){t&&t(2,e)}(s,n)}finally{Aw(r)}}function rx(t){return t[bw]}var ix=ww;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function ox(t){return{components:[],scheduler:t,clean:ix}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.createLanguageService=Cl,t.TypeScriptServiceHost=kx,t.createLanguageServiceFromTypescript=
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
