...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(e,t),t}finally{n.end&&n.end()}}function Mg(e){Pg(e[wm])}function Og(e,t){var n=e[fm],r=fy(e,e[gm]),i=n.template,o=ly(e);try{zm(e),o&&Rg(1,n,t),Tg(i,Ng(e),t),wg(e),o&&!n.staticViewQueries||Rg(2,n,t)}finally{dy(r)}}function Rg(e,t,n){var r=t.viewQuery;r&&r(e,n)}var Dg=Promise.resolve(null),Lg=[];function Fg(e,t,n,r,i){for(var o,s,a=e[fm].node,u=-1,l=e,c=a.child;c;){var h=null;if(3===c.type||4===c.type){jg(t,n,r,jm(c,l),c,i);var f=l[c.index];Fm(f)&&(jg(t,n,r,f[Mm],c,i),f[Om].length&&(h=(l=f[Om][0])[fm].node,i=f[Mm]))}else if(0===c.type){var d=l[c.index];jg(t,n,r,d[Mm],c,i),d[Om].length&&(h=(l=d[Om][0])[fm].node,i=d[Mm])}else if(1===c.type){var v=ky(l),m=v[gm].projection[c.projection];if(Array.isArray(m))try{for(var y=p(m),g=y.next();!g.done;g=y.next())jg(t,n,r,g.value,c,i)}catch(e){o={error:e}}finally{try{g&&!g.done&&(s=y.return)&&s.call(y)}finally{if(o)throw o.error}}else Lg[++u]=c,Lg[++u]=l,m&&(h=(l=v[vm])[fm].data[m.index])}else h=c.child;if(null===h)for(null===c.projectionNext&&2&c.flags&&(l=Lg[u--],c=Lg[u--]),h=2&c.flags?c.projectionNext:4===c.type&&c.child||c.next;!h;){if(null===(c=c.parent||l[gm])||c===a)return;if(0===c.type&&(i=(l=Ny(l))[c.index][Mm]),2===c.type){for(;!l[mm]&&l[vm]&&(!c.parent||!c.parent.next);){if(c===a)return;if(Fm(l=l[vm])){c=l[gm],i=(l=l[vm])[c.index][Mm];break}c=l[gm]}h=l[mm]?(l=l[mm])[gm]:4===c.type&&c.child||c.next}else h=c.next}c=h}}function jg(e,t,n,r,i,o){0===e?function s(e,t,n,r){yy(e)?e.insertBefore(t,n,r):t.insertBefore(n,r,!0)}(t,n,r,o||null):1===e?function a(e,t,n){var r=function i(e,t){return yy(e)?e.parentNode(t):t.parentNode}(e,t);r&&function o(e,t,n,r){yy(e)?e.removeChild(t,n,r):t.removeChild(n)}(e,r,t,n)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function kC(e){return{start:e.getStart(),end:e.getEnd()}}function AC(e){return{message:e.message,next:e.next?AC(e.next):void 0}}var PC=new WeakMap,IC=new I_("8.0.0-rc.0+69.sha-00ffc03.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
