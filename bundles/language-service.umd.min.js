...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function oT(e){return{start:e.getStart(),end:e.getEnd()}}function sT(e){return{message:e.message,next:e.next?sT(e.next):void 0}}var aT=new WeakMap,uT=new ab("8.0.0-rc.0+360.sha-7757826.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
