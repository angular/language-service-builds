 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Bi(t){return t.map(function(t){return t.visit(Hi)}).join("")}var qi=function(){function t(t){var e=this;this.attrs={},Object.keys(t).forEach(function(n){e.attrs[n]=Qi(t[n])})}return t.prototype.visit=function(t){return t.visitDeclaration(this)},t}(),Ki=function(){function t(t,e){this.rootTag=t,this.dtd=e}return t.prototype.visit=function(t){return t.visitDoctype(this)},t}(),Ui=function(){function t(t,e,n){void 0===e&&(e={}),void 0===n&&(n=[]);var r=this;this.name=t,this.children=n,this.attrs={},Object.keys(e).forEach(function(t){r.attrs[t]=Qi(e[t])})}return t.prototype.visit=function(t){return t.visitTag(this)},t}(),zi=function(){function t(t){this.value=Qi(t)}return t.prototype.visit=function(t){return t.visitText(this)},t}(),Wi=function(t){function e(e){return void 0===e&&(e=0),t.call(this,"\n"+new Array(e+1).join(" "))||this}return o(e,t),e}(zi),Gi=[[/&/g,"&amp;"],[/"/g,"&quot;"],[/'/g,"&apos;"],[/</g,"&lt;"],[/>/g,"&gt;"]];function Qi(t){return Gi.reduce(function(t,e){return t.replace(e[0],e[1])},t)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Vp=function mt(t){this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")},Hp=new Vp("6.1.0-beta.2+20.sha-1e139d4"),Bp="ngDebugContext",qp="ngOriginalError",Kp="ngErrorLogger";function Up(t){return t[Bp]}function zp(t){return t[qp]}function Wp(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];t.error.apply(t,l(e))}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var _b=14,bb=0,wb=1,xb=2,Eb=3,Sb=4,Cb=5,Tb=6,Pb=7,Ab=8,Nb=9,Ob=10,kb=11,Mb=12;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var jb,Lb=0,Fb=4,Vb=5;function Hb(t){return!!t.listen}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function Bb(t){if(2===t.tNode.type){var e=t.data;return e[xb]?e[xb][Cb]:null}return t.tNode.next?t.view[t.tNode.next.index]:null}function qb(t){return t.pChild?t.pChild:t.tNode.child?(2===t.tNode.type?t.data:t.view)[t.tNode.child.index]:null}function Kb(t){if(-1===t.tNode.index)return t.dynamicParent;var e=t.tNode.parent;return e?t.view[e.index]:t.view[Cb]}function Ub(t){var e=t.pNextOrParent;return e?1===e.tNode.type?null:e:Bb(t)}function zb(t,e,n,r,i,o){for(var s=t;s;){var a=null,u=i?i.native:null;if(3===s.tNode.type)Wb(n,r,u,s.native,o),s.dynamicLContainerNode&&Wb(n,r,u,s.dynamicLContainerNode.native,o),a=Bb(s);else if(0===s.tNode.type){Wb(n,r,u,s.native,o);var c=s,l=c.dynamicLContainerNode?c.dynamicLContainerNode.data:c.data;i&&(l[Vb]=i),(a=l[Fb].length?qb(l[Fb][0]):null)&&(o=c.dynamicLContainerNode?c.dynamicLContainerNode.native:c.native)}else a=1===s.tNode.type?s.data.head:qb(s);if(null==a){var p=s;for(s=Ub(p);p&&!s;){if((p=p.pNextOrParent||Kb(p))===e)return null;p&&!p.pNextOrParent&&0===p.tNode.type&&(o=p.native),s=p&&Ub(p)}}else s=a}}function Wb(t,e,n,r,i){0===t?Hb(e)?e.insertBefore(n,r,i):n.insertBefore(r,i,!0):1===t?Hb(e)?e.removeChild(n,r):n.removeChild(r):2===t&&e.destroyNode(r)}function Gb(t,e,n,r){var i=t.data[Vb];i&&i.native&&zb(qb(e),e,n?0:1,t.view[kb],i,r)}function Qb(t,e){var n=t.data[Fb],r=n[e];e>0&&(n[e-1].data[xb]=r.data[xb]),n.splice(e,1),t.tNode.detached||Gb(t,r,!1);var i=r.data;return i[Eb]&&i[Eb].removeView(),r.data[Sb]&=-9,r}function Xb(t){if(-1===t[bb].childIndex)return null;var e=t[t[bb].childIndex];return e.data?e.data:e.dynamicLContainerNode.data}function Yb(t){var e=t[kb];Hb(e)&&e.destroyNode&&zb(t[Cb],t[Cb],2,e),function n(t){if(-1===t[bb].childIndex)return $b(t);for(var e=Xb(t);e;){var n=null;if(e.length>=_b?e[bb].childIndex>-1&&(n=Xb(e)):e[Fb].length&&(n=e[Fb][0].data),null==n){for(;e&&!e[xb]&&e!==t;)$b(e),e=Zb(e,t);$b(e||t),n=e&&e[xb]}e=n}}(t),t[Sb]|=32}function Zb(t,e){var n;return(n=t[Cb])&&2===n.tNode.type?Kb(n).data:t[wb]===e?null:t[wb]}function $b(t){if(t[bb]){var e=t;!function n(t){var e=t[bb].cleanup;if(null!=e){for(var n=0;n<e.length-1;n+=2)"string"==typeof e[n]?(t[e[n+1]].native.removeEventListener(e[n],t[Ab][e[n+2]],e[n+3]),n+=2):"number"==typeof e[n]?(0,t[Ab][e[n]])():e[n].call(t[Ab][e[n+1]]);t[Ab]=null}}(e),function r(t){var e,n=t[bb];null!=n&&null!=(e=n.destroyHooks)&&Db(t[Pb],e)}(e),function i(t){var e=t[bb]&&t[bb].pipeDestroyHooks;e&&Db(t,e)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(e),-1===e[bb].id&&Hb(e[kb])&&e[kb].destroy()}}!function(t){t[t.Important=1]="Important",t[t.DashCase=2]="DashCase"}(jb||(jb={}));var Jb,tw,ew,nw,rw,iw,ow,sw,aw,uw="__ngHostLNode__",cw=Promise.resolve(null),lw=[0,0],pw=new Array(_b).fill(null),hw=!1,fw=!0;function dw(t,e){var n=sw;return aw=t&&t[Pb],rw=t&&t[bb],ow=t&&1==(1&t[Sb]),fw=t&&rw.firstTemplatePass,Jb=t&&t[kb],null!=e&&(ew=e,nw=!0),sw=t,iw=t&&t[Eb],n}function vw(t,e){e||(hw||Rb(aw,rw.viewHooks,rw.viewCheckHooks,ow),sw[Sb]&=-6),sw[Sb]|=16,sw[Tb]=-1,dw(t,null)}function yw(){hw||Ib(sw,rw,ow),function t(e){for(var n=Xb(e);null!==n;n=n[xb])if(n.length<_b&&null===n[Lb])for(var r=n,i=0;i<r[Fb].length;i++){var o=r[Fb][i],s=o.data;bw(o,s[bb],s[Nb],Jb)}}(sw),hw||Rb(aw,rw.contentHooks,rw.contentCheckHooks,ow),rw.firstTemplatePass=fw=!1,mw(rw.hostBindings),function e(t){if(null!=t)for(var e=0;e<t.length;e+=2)Tw(t[e],t[e+1])}(rw.components)}function mw(t){if(null!=t)for(var e=rw.directives,n=0;n<t.length;n+=2){var r=t[n],i=e[r];i.hostBindings&&i.hostBindings(r,t[n+1])}}function gw(t,e,n,r,i){return[e,sw,null,null,25|r,null,-1,null,null,n,sw&&sw[Ob],t,i||null,null]}function _w(t,e,n,r,i,o){var s=nw?ew:ew&&Kb(ew),a=s&&s.view===sw?s.tNode:null,u=(nw?iw:ew&&ew.queries)||s&&s.queries&&s.queries.child(),c=null!=o,l=function p(t,e,n,r,i,o){return{native:r,view:e,nodeInjector:n?n.nodeInjector:null,data:i,queries:o,tNode:null,pNextOrParent:null,dynamicLContainerNode:null,dynamicParent:null,pChild:null}}(0,sw,s,n,c?o:null,u);if(-1===t||2===e)l.tNode=(o?o[bb].node:null)||Cw(e,t,null,null,a,null);else{var h=t+_b,f=rw.data;if(sw[h]=l,h>=f.length){var d=f[h]=Cw(e,h,r,i,a,null);if(!nw&&ew){var v=ew.tNode;v.next=d,v.dynamicContainerNode&&(v.dynamicContainerNode.next=d)}}l.tNode=f[h],nw&&(iw=null,(null==ew.tNode.child&&ew.view===sw||2===ew.tNode.type)&&(ew.tNode.child=l.tNode))}if(2==(2&e)&&c){var y=o;y[Cb]=l,fw&&(y[bb].node=l.tNode)}return ew=l,nw=!0,l}function bw(t,e,n,r,i){var o,s=nw,a=ew,u=2;try{if(nw=!0,ew=null,null==t){var c=gw(r,e,n,2,function l(){return sw&&sw[Mb]}());i&&(c[Eb]=i.createView()),t=_w(-1,2,null,null,null,c),u=1}o=dw(t.data,t),e.template(u,n),2&u?yw():t.data[bb].firstTemplatePass=fw=!1}finally{vw(o,1==(1&u)),nw=s,ew=a}return t}function ww(t,e,n,r){var i=dw(e,t);try{tw.begin&&tw.begin(),r?(r(xw(e),n),yw()):(function o(){hw||(Ib(sw,rw,ow),Rb(aw,rw.contentHooks,rw.contentCheckHooks,ow))}(),mw(lw),Tw(0,_b))}finally{tw.end&&tw.end(),vw(i)}}function xw(t){return 1&t[Sb]?3:2}function Ew(t,e,n,r,i){return{id:t,template:e,viewQuery:i,node:null,data:pw.slice(),childIndex:-1,bindingStartIndex:-1,directives:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,hostBindings:null,components:null,directiveRegistry:"function"==typeof n?n():n,pipeRegistry:"function"==typeof r?r():r,currentMatches:null}}function Sw(t,e){tw=t;var n=t.createRenderer(null,null);return"string"==typeof e?Hb(n)?n.selectRootElement(e):n.querySelector(e):e}function Cw(t,e,n,r,i,o){return{type:t,index:e,flags:0,tagName:n,attrs:r,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:o,next:null,child:null,parent:i,dynamicContainerNode:null,detached:null}}function Tw(t,e){var n=sw[e],r=n.data;Pw(r)&&6&r[Sb]&&Ow(r,n,function i(t){return Array.isArray(t)?t[0]:t}(aw[t]))}function Pw(t){return 8==(8&t[Sb])}function Aw(t){for(var e=kw(t).view;e[wb];)e=e[wb];return e}function Nw(t){var e=kw(t);Ow(e.data,e,t)}function Ow(t,e,n){var r=dw(t,e),i=t[bb],o=i.template,s=i.viewQuery;try{!function a(t,e,n){t&&1&e&&t(1,n)}(s,t[Sb],n),o(xw(t),n),yw(),function u(t,e){t&&t(2,e)}(s,n)}finally{vw(r)}}function kw(t){return t[uw]}var Mw=cw,Iw=function(){function t(t,e){this._view=t,this.context=e}return t.prototype._setComponentContext=function(t,e){this._view=t,this.context=e},Object.defineProperty(t.prototype,"destroyed",{get:function(){return 32==(32&this._view[Sb])},enumerable:!0,configurable:!0}),t.prototype.destroy=function(){Yb(this._view)},t.prototype.onDestroy=function(t){!function e(t,n){(function r(t){return t[Ab]||(t[Ab]=[])})(t).push(n),t[bb].firstTemplatePass&&function i(t){return t[bb].cleanup||(t[bb].cleanup=[])}(t).push(t[Ab].length-1,null)}(this._view,t)},t.prototype.markForCheck=function(){!function t(e){for(var n=e;null!=n[wb];)n[Sb]|=4,n=n[wb];n[Sb]|=4,function r(t){var e;t.clean==cw&&(t.clean=new Promise(function(t){return e=t}),t.scheduler(function(){!function n(t){for(var e=0;e<t.components.length;e++){var n=t.components[e];ww(kw(n),Aw(n),n)}}(t),e(null),t.clean=cw}))}(n[Nb])}(this._view)},t.prototype.detach=function(){this._view[Sb]&=-9},t.prototype.reattach=function(){this._view[Sb]|=8},t.prototype.detectChanges=function(){Nw(this.context)},t.prototype.checkNoChanges=function(){!function t(e){hw=!0;try{Nw(e)}finally{hw=!1}}(this.context)},t.prototype.detachFromAppRef=function(){this._appRef=null},t.prototype.attachToAppRef=function(t){this._appRef=t},t}(),Rw=(function(t){function e(e,n,r){var i=t.call(this,e.data,r)||this;return i._viewContainerRef=null,i._lViewNode=e,i}o(e,t),e.prototype.destroy=function(){this._viewContainerRef&&Pw(this._view)&&(this._viewContainerRef.detach(this._viewContainerRef.indexOf(this)),this._viewContainerRef=null),t.prototype.destroy.call(this)},e.prototype.attachToViewContainerRef=function(t){this._viewContainerRef=t}}(Iw),function(){function t(t){this._lContainerNode=t,this._viewRefs=[]}t.prototype.clear=function(){for(var t=this._lContainerNode.data;t[Fb].length;)this.remove(0)},t.prototype.get=function(t){return this._viewRefs[t]||null},Object.defineProperty(t.prototype,"length",{get:function(){return this._lContainerNode.data[Fb].length},enumerable:!0,configurable:!0}),t.prototype.createEmbeddedView=function(t,e,n){var r=t.createEmbeddedView(e||{});return this.insert(r,n),r},t.prototype.createComponent=function(t,e,n,r,i){throw function o(){return new Error("NotImplemented")}()},t.prototype.insert=function(t,e){if(t.destroyed)throw new Error("Cannot insert a destroyed View in a ViewContainer!");var n=t._lViewNode,r=this._adjustIndex(e);return t.attachToViewContainerRef(this),function i(t,e,n){var r=t.data[Fb];n>0&&(r[n-1].data[xb]=e.data),n<r.length?(e.data[xb]=r[n].data,r.splice(n,0,e)):(r.push(e),e.data[xb]=null);var i=e.data;i[Eb]&&i[Eb].insertView(n),null===t.data[Vb]||t.tNode.detached||Gb(t,e,!0,n+1<r.length?qb(r[n+1]).native:t.native),e.data[Sb]|=8}(this._lContainerNode,n,r),n.dynamicParent=this._lContainerNode,this._viewRefs.splice(r,0,t),t},t.prototype.move=function(t,e){var n=this.indexOf(t);return this.detach(n),this.insert(t,this._adjustIndex(e)),t},t.prototype.indexOf=function(t){return this._viewRefs.indexOf(t)},t.prototype.remove=function(t){var e=this._adjustIndex(t,-1);!function n(t,e){var n=t.data[Fb][e];Qb(t,e),Yb(n.data)}(this._lContainerNode,e),this._viewRefs.splice(e,1)},t.prototype.detach=function(t){var e=this._adjustIndex(t,-1);return Qb(this._lContainerNode,e).dynamicParent=null,this._viewRefs.splice(e,1)[0]||null},t.prototype._adjustIndex=function(t,e){return void 0===e&&(e=0),null==t?this._lContainerNode.data[Fb].length+e:t}}(),function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return o(e,t),e.prototype.resolveComponentFactory=function(t){return new Fw(t.ngComponentDef)},e}(ly));
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function Dw(t){var e=[];for(var n in t)t.hasOwnProperty(n)&&e.push({propName:t[n],templateName:n});return e}var jw=new kl("ROOT_CONTEXT_TOKEN",{providedIn:"root",factory:function(){return function t(e){return{components:[],scheduler:e,clean:Mw}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
t.createLanguageService=Cl,t.TypeScriptServiceHost=Ww,t.createLanguageServiceFromTypescript=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
