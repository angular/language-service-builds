...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function aT(e){return{start:e.getStart(),end:e.getEnd()}}function uT(e){return{message:e.message,next:e.next?uT(e.next):void 0}}var lT=new WeakMap,cT=new ub("8.0.0-rc.0+383.sha-41f372f.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
