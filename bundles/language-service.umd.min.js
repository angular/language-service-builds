...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function fT(e){return{start:e.getStart(),end:e.getEnd()}}function dT(e){return{message:e.message,next:e.next?dT(e.next):void 0}}var vT=new WeakMap,mT=new hb("8.1.0+41.sha-fa69e99.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
